 ...
 *               category:
 *                 type: string
 *                 enum: [music-production, mixing-mastering, songwriting, vocal-recording, beat-making, lyrics-writing, voice-over, podcast-editing, sound-design, jingle-creation, other]
 *               subcategory:
 *                 type: string
 *               description:
 *                 type: string
